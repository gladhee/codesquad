...
public class Plane {
    ...
    public String toString() {
        ...
        drawPerpendicular(plane, diagram.getPoints());
    ...
    private void drawPerpendicular(char[][] plane, List<Point> points) {
        for (Point p : points) {
            ...
            int rowP2 = p.y() + Y_OFFSET;
            int colP2 = X_OFFSET + 2 * p.x();
